 ...
 */
const age = 10;
const phrase = `Mon âge est ${age} ans`; // touche 7
console.log(phrase);
...
console.log(char8.search("baleine"));
...
console.log(char9.toLocaleLowerCase('FR'));
console.log(char9.toLocaleUpperCase('FR'));
 ...
 * - CamelCase
 */
var str = '   Supprimez les espaces avant et après cette phrase    ';
/*str = str.trim();
const space = / /g;
